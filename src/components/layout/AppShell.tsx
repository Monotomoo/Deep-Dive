...
const VIEW_SUBTITLES: Partial<Record<ViewKey, string>> = {
  ...
  spine:         'the ideas workshop · candidate spines moving from draft to leading',
  shoots:        '10 stages · Krk ✓ · Sicily ✓ + Etna · Lastovo ✓ · training camp · Cyprus · records · Rijeka · USA · Philippines · coda',
  ...
  records:       "Petar CNF 103m · Vito ~29min · Sanda first HR past 100m · Zsófia FIM 105m + new WR pending (Lastovo)",
  ...
  scenario:      'three plans · what each raises, what it costs, and what carries the risk',
