...
- **Idea Hub / Topics reworked** — replaced the 10 thematic topics with 10 production topics, each with a real description: Krk→Sicily→Lastovo interview through-line · Lastovo camp & the sport · Rijeka labs · Njivice origin (Pero) · Sea Shepherds · USA Hall of Fame · deep interviews in Rijeka · Mexico caves · Vito's deepest dive · Body & brain. Rewired story-events, interviews and idea-hub links off the retired topic IDs (interviews now tag the Krk→Sicily→Lastovo through-line, so the new topics stay wired).
